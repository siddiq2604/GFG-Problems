<h2><a href="https://practice.geeksforgeeks.org/problems/special-odd-series-sum1235/1?page=1&category[]=series&sortBy=submissions">Special Odd Series Sum</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given the value of n, we need to find the sum of the series where i-th term is sum of first i odd natural numbers.</span></p>
